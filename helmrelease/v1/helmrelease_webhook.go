/*
Copyright 2021 The Kubernetes demo.
...
//+kubebuilder:webhook:path=/mutate-kubehelm-xuan-cn-v1-helmrelease,mutating=true,failurePolicy=fail,sideEffects=None,groups=kubehelm.xuan.cn,resources=helmreleases,verbs=create;update,versions=v1,name=mhelmrelease.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-kubehelm-xuan-cn-v1-helmrelease,mutating=false,failurePolicy=fail,sideEffects=None,groups=kubehelm.xuan.cn,resources=helmreleases,verbs=create;update,versions=v1,name=vhelmrelease.kb.io,admissionReviewVersions=v1
